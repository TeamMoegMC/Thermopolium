...
public class SCFluids {
    ...
    public static final ResourceLocation STILL_MILK_TEXTURE=new ResourceLocation("forge", "block/milk_still");
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(ForgeRegistries.FLUIDS, Main.MODID);
    public static final Map<String,TAC> soupfluids=new HashMap<>();
    ...
    public static void init() {
    	...
    	for(Entry<String, TAC> i:soupfluids.entrySet()) {
    		FLUIDS.register(i.getKey(), () -> new SoupFluid(new ForgeFlowingFluid.Properties(null,null,SoupAttributes.builder(i.getValue().t,i.getValue().t)
                .viscosity(1200).color(i.getValue().c).temperature(333).rarity(Rarity.UNCOMMON))
